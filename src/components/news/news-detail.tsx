  ...
  return (
    <article className={cn('max-w-4xl mx-auto', className)}>
      ...
      <div className="space-y-4 text-gray-800 dark:text-gray-200">
        {/* Abstract as highlighted summary */}
        <div className="p-4 bg-gray-100 dark:bg-gray-800 rounded-lg border-l-4 border-blue-500 mb-6">
          <p className="italic">{abstract}</p>
        </div>

        {/* Main content - would normally be rendered from content field */}
        <div className="prose dark:prose-invert max-w-none">
          <p>
            {abstract}
            {/* Using abstract as placeholder for full content */}
          </p>

          {/* If we had actual content, we would render it here */}
      ...
      <footer className="mt-8 pt-4 border-t border-gray-200 dark:border-gray-700">
        <div className="flex justify-between items-center">
          <p className="text-sm text-gray-500 dark:text-gray-400">Source: {sourceDisplay}</p>
